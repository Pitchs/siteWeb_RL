...
<div id="tabs">
  ...
  <div id="tabs-1">
	...
	<p> Ressources fournis afin de pouvoir modifier le site, après la formation.</p>
	</br>
	<object type="application/pdf" name="PDF3" id="PDF" width="100%" height="800px" data="ressources/DocSiteValletInfo2014.pdf">
		</object> 
  </div>
  <div id="tabs-2">
		<p>
		...
		<object type="application/pdf" name="PDF" id="PDF" width="100%" height="800px" data="ressources/Compte_rendu_de_stage_cnam.pdf">
		</object> 

		<p>
			<h2>Annex de stage :</h2>
		</p>
		<object type="application/pdf" name="PDF2" id="PDF" width="100%" height="700px" data="ressources/Annex_compte_rendu_de_stage_cnam.pdf">
		</object> 
	</div>
</div>
